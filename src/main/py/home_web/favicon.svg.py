...
print("""<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" version="1">
 ...
 <path d="m 42,4.9999994 -6,5.9999996 h -8 v 8 L 22,25 l 6,6 v 8 h 8 l 6,6 6,-6 h 8 v -8 l 6,-6 -6,-6.000001 v -8 h -8 z" style="opacity:0.2;fill:#0d0d08"/>
 <path style="fill:#ff8a47" d="m 42,4 -6,6 h -8 v 8 l -6,6 6,6 v 8 h 8 l 6,6 6,-6 h 8 v -8 l 6,-6 -6,-6 v -8 h -8 z"/>
 <circle cx="42" cy="25" r="12" style="opacity:0.2;fill:#0d0d08"/>
 ...
 <circle cx="30" cy="42" r="12" style="fill:#ffffff"/>
 <circle cx="45" cy="51" r="9" style="fill:#ffffff"/>
